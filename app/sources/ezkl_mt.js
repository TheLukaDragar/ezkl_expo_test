...
function __wbg_init_memory(imports, maybe_memory) {
    imports.wbg.memory = maybe_memory || new WebAssembly.Memory({initial:20,maximum:65536,shared:true});
}
...
export { initSync, __wbg_get_imports,__wbg_init_memory,__wbg_finalize_init,__wbg_init };
