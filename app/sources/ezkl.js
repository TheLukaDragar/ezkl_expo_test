...
function getUint8Memory0() {
    if (cachedUint8Memory0 === null || cachedUint8Memory0.byteLength === 0) {
        ...
        console.log("getUint8Memory0 cachedUint8Memory0", cachedUint8Memory0);
    }
    console.log("getUint8Memory0 cachedUint8Memory0", cachedUint8Memory0);
...
function passArray8ToWasm0(arg, malloc) {
    ...
    console.log("passArray8ToWasm0 ptr", ptr);
    getUint8Memory0().set(arg, ptr / 1);
    console.log("passArray8ToWasm0 arg", arg);
    WASM_VECTOR_LEN = arg.length;
    console.log("passArray8ToWasm0 WASM_VECTOR_LEN", WASM_VECTOR_LEN);
    return ptr;
}
...
* @returns {Uint8ClampedArray}
*/
export function bufferToVecOfVecU64(buffer) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function genWitness(compiled_circuit, input) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {boolean}
*/
export function verify(proof_js, vk, settings, srs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function prove(witness, pk, compiled_circuit, srs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
export const setWasm = (newWasm) => {
    wasm = newWasm;
  };

export { initSync,__wbg_get_imports,wasm }
